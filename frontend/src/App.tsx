    ...
    <div className="w-full min-h-screen bg-gray-900 flex justify-center px-4">
      <main className="my-10 w-full md:max-w-2xl">
        ...
        <form className="flex flex-col my-6" onSubmit={handleSubmit}>
          ...
          <input type="text" placeholder="Digite seu nome completo..." className="w-full mb-5 p-2 rounded" ref={nameRef}></input>
          <label className="font-medium text-white">Email:</label>
          <input type="email" placeholder="Digite seu email..." className="w-full mb-5 p-2 rounded" ref={emailRef}></input>
          <input type="submit" value="Cadastrar" className="cursor-pointer w-full p-2 bg-green-500 rounded text-white font-medium"></input>
        </form>
